  ...
  return (
    <div className="page-shell max-w-4xl">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-white sm:text-4xl animate-fade-in-up" style={{ animationDelay: "100ms" }}>Publications</h1>
        <p className="mt-2 text-slate-300 animate-fade-in-up" style={{ animationDelay: "200ms" }}>
