    ...
    <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            <select
              ...
              className="rounded-md border border-slate-700/50 bg-slate-800/60 px-2.5 py-1.5 text-xs text-slate-300 outline-none focus:border-cyber-500/40"
            >
      ...
      {filtered.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate-700 bg-slate-800/30 p-12 text-center">
          <p className="text-sm text-slate-400">No publications match your filters.</p>
        </div>
      ) : (
