      ...
      <div className="mb-6 space-y-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-700/50 bg-slate-800/70 py-2.5 pl-10 pr-4 text-sm text-white placeholder-slate-400 outline-none transition-colors focus:border-cyber-500/50 focus:ring-1 focus:ring-cyber-500/20"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            <select
              ...
              className="rounded-md border border-slate-700/50 bg-slate-800/70 px-2.5 py-1.5 text-xs text-slate-200 outline-none focus:border-cyber-500/40"
            >
