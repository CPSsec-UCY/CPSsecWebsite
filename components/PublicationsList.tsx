      ...
      <div className="mb-6 space-y-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-700/50 bg-slate-800/60 py-2.5 pl-10 pr-4 text-sm text-white placeholder-slate-500 outline-none transition-all focus:border-cyber-500/50 focus:ring-2 focus:ring-cyber-500/20"
          />
        </div>
