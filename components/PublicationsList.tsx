      ...
      <div className="mb-6 space-y-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-cyber-500/20 bg-slate-900 py-2.5 pl-10 pr-4 text-sm text-white placeholder-slate-500 outline-none transition-colors focus:border-cyber-500/50 focus:ring-1 focus:ring-cyber-500/20"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            <select
              ...
              className="rounded-md border border-cyber-500/15 bg-slate-900 px-2.5 py-1.5 text-xs text-slate-300 outline-none focus:border-cyber-500/40"
            >
          ...
          {hasFilters && (
            <button
              ...
              className="inline-flex items-center gap-1 rounded-md px-2 py-1.5 text-xs text-slate-400 hover:text-white transition-colors"
            >
              <X className="h-3 w-3" />
              Clear
            </button>
